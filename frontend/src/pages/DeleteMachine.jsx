...
const DeleteMachine = () => {
  ...
  return (
    <div className='flex flex-col justify-center items-center h-screen' style={{ backgroundColor: 'white' }}>
      <div className='p-4'>
        <h1 className='text-3xl my-4'>Delete Machine</h1>
        {loading ? <Spinner /> : ''}
        <div className='flex flex-col items-center border-2 border-sky-400 rounded-xl w-[600px] p-8 shadow-lg'>
          <h3 className='text-2xl'>Are you sure you want to delete this machine?</h3>
          <button onClick={handleDeleteMachine} className='bg-red-500 text-white p-2 mt-4 rounded-md hover:bg-red-600 transition-all'>
            Delete It
          </button>
        </div>
      </div>
