...
const PaymentsEmployeeEdit = () => {
    ...
    useEffect(() => {
        setLoading(true);
        axios.get(`http://localhost:5555/employeePayments/${id}`)
            .then((response) => {
    ...
    const handleSavePayment = () => {
        setLoading(true);
        axios.put(`http://localhost:5555/employeePayments/update/${id}`, payment)
            .then(() => {
                setLoading(false);
                navigate('/EmployeePayments');
            })
            .catch((error) => {
                setLoading(false);
...
export default PaymentsEmployeeEdit;
